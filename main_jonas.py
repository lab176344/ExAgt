...
# dataset number
# dataset hypers
dataset_train = [{'name':'argoverse','augmentation_type':["no"],'mode':'train','bbox_meter': [200, 200],'bbox_pixel':[100,100],'center_meter':[100.0,100.0],\
           'hist_seq_first':0,'hist_seq_last':49,'representation_type':'image_vector_merge_recon','orientation':'north'}]
                   

dataset_test = [{'name':'argoverse','augmentation_type':["no"],'mode':'test','bbox_meter': [200, 200],'bbox_pixel':[100,100],'center_meter':[100.0,100.0],\
           'hist_seq_first':0,'hist_seq_last':49,'representation_type':'image_vector_merge_recon','orientation':'north'}]

# dataloader number
# dataloader hypers

train_dataloader = {'idx':100, 'batch_size':32,'epochs':100, 'num_workers':6,'shuffle':True,
                    'representation':'trajectory'}              
       


test_dataloader = {'idx':101, 'batch_size':32, 'num_workers':6,
